...
# INDIVIDUAL_TEMPLATE reste inchangé - sera copié depuis l'original
...
<body>
    <div class="container">
        <header>
            <h1>📊 Analyse Monte Carlo - {{strategy_full_name}}</h1>
            <p class="subtitle">Simulation de risque et capital optimal</p>
            ...
            <div class="card">
                ...
                <div class="stat-grid">
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-label">Niveaux Capital</div>
                    </div>
                    <div class="stat">
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-label">Seuil Ruine</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="chart-row">
            ...
            <div class="card">
                <h2>📈 Ratio Return/DD vs Capital</h2>
                <div class="chart-container">
                    <canvas id="returnDDChart"></canvas>
                </div>
            </div>
        </div>
        ...
        <footer>
            <p>Méthodologie Kevin Davey - Building Winning Algorithmic Trading Systems</p>
        </footer>
    </div>
    ...
    <script>
        ...
        const chartOptions = {{
            ...
            scales: {{
                x: {{ 
                    title: {{ display: true, text: 'Capital Initial ($)', color: '#4ecdc4' }},
            ...
            options: {{
                ...
                scales: {{
                    ...
                    y: {{ 
                        ...
                        title: {{ display: true, text: 'Probabilité de Ruine', color: '#ff6b6b' }},
                        max: 1
                    }}
                }},
                plugins: {{
                    ...chartOptions.plugins,
                    annotation: recommendedCapital > 0 ? {{
                        annotations: {{
                            line1: {{
                                type: 'line',
                                xMin: recommendedCapital,
                                xMax: recommendedCapital,
                                borderColor: '#00d4aa',
                                borderWidth: 2,
                                borderDash: [5, 5]
                            }}
        ...
        // Graphique Return/DD
        new Chart(document.getElementById('returnDDChart'), {{
            type: 'line',
            data: {{
                labels: capitalLevels,
                datasets: [{{
            ...
            options: {{
                ...
                scales: {{
                    ...
                    y: {{ 
                        ...chartOptions.scales.y,
                        title: {{ display: true, text: 'Return/DD Ratio', color: '#00d4aa' }}
                    }}
                }}
            }}
        }});
        ...
        new Chart(document.getElementById('profitChart'), {{
            ...
            options: {{
                ...
                scales: {{
                    ...
                    y: {{ 
                        ...chartOptions.scales.y,
                        title: {{ display: true, text: 'Profit Médian ($)', color: '#4ecdc4' }}
                    }}
                }}
            }}
        }});
        
        // Graphique Probabilité Positive
        new Chart(document.getElementById('probChart'), {{
            ...
            options: {{
                ...
                scales: {{
                    ...
                    y: {{ 
                        ...chartOptions.scales.y,
                        title: {{ display: true, text: 'Probabilité > 0', color: '#ffe66d' }},
                        max: 1
                    }}
                }}
            }}
...
# LE NOUVEAU SUMMARY_TEMPLATE COMMENCE ICI
SUMMARY_TEMPLATE = """
<!DOCTYPE html>
<html lang="fr">
<head>
